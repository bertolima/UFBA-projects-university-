...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=11215577&assignment_repo_type=AssignmentRepo)
...
O simulador do jogo de Mico foi desenvolvido utilizando estruturas de dados apropriadas para armazenar as cartas e as informações dos jogadores. A escolha dessas estruturas foi baseada na necessidade de manipular eficientemente as cartas durante o jogo.

Foram implementadas classes para representar as cartas, os jogadores e o jogo em si. Essas classes utilizam listas para armazenar as cartas, permitindo acesso rápido e fácil às mesmas. Além disso, a função random.shuffle() foi utilizada para embaralhar o baralho de cartas.

A complexidade dos principais métodos utilizados no simulador varia de acordo com o tamanho do baralho e o número de jogadores. O método de embaralhar possui complexidade O(n), onde n é o número de cartas no baralho. Já o método de distribuir as cartas possui complexidade O(n), onde n é o número de cartas no baralho.

O simulador permite acompanhar as jogadas na tela, exibindo as cartas de cada jogador e a carta no topo do monte de cada jogador. A partida continua até que todas as cartas sejam jogadas e um jogador seja declarado vencedor.

Para utilizar o simulador, basta executar o arquivo Python fornecido. É possível modificar o número de jogadores antes de executar o programa, caso desejado.
